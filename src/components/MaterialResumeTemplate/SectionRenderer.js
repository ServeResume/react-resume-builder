...
import { Header, Content, Title } from "./Utils/Section";
...
const SectionRenderer = ({
  ...
  ({
    about: (
      <Paper>
        <Content>
          <AboutMeSection about={about} jobTitleFontColor={colors.grey700} />
        </Content>
      </Paper>
    ),
    professionalSkills: (
      <Paper>
        <Header>
          <Title color={colors.blue}>Professional Skills</Title>
        </Header>
        <Content>
          <SkillsSection
    ...
    projects: (
      <Paper>
        <Header>
          <Title color={colors.blue}>Projects</Title>
        </Header>
        <Content>
    ...
    workExperiences: (
      <Paper>
        <Header>
          <Title color={colors.blue}>Working Experience</Title>
        </Header>
        <Content>
          <WorkExperiencesSection
            rolesFontColor={colors.grey700}
    ...
    contact: (
      <Paper bgColor={colors.blue}>
        <Header>
          <Title color={colors.white}>Contact me</Title>
        </Header>
        <Content>
          <ContactMeSection
    ...
    educations: (
      <Paper>
        <Header>
          <Title color={colors.blue}>Education</Title>
        </Header>
        <Content>
          <EducationsSection
    ...
    workEnvironment: (
      <Paper>
        <Header>
          <Title color={colors.blue}>Development Tools</Title>
        </Header>
        <Content>
          <SkillsSection
            columnTitleColor={colors.blue}
    ...
    awards: (
      <Paper>
        <Header>
          <Title color={colors.blue}>Awards</Title>
        </Header>
        <Content>
          <AwardsSection summaryColor={colors.grey700} awards={awards} />
        </Content>
      </Paper>
    ),
    references: (
      <Paper>
        <Header>
          <Title color={colors.blue}>References</Title>
        </Header>
        <Content>
          <ReferencesSection
